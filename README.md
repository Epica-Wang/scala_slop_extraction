...
Clone the directory and run command 
docker-compose run --rm accern_template bash


For first time run this will create the container and step you inside
the container

Once the Container up and your attached to it.
run 
`sbt` to get started

within sbt u can use compile, test and run command


a sample hello world is working already
a sample test case is wired up already
...
you should fork the repo and provide your solution
